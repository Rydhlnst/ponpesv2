          ...
          <ScrollAnimation direction="down">
            <div className="max-w-2xl space-y-3">
              ...
              <p className="text-white/70 text-sm sm:text-base leading-relaxed">
                Temukan jawaban untuk pertanyaan umum seputar pendaftaran,
                biaya, dan program di Pesantren As Salam Metro.
              </p>
            </div>
          </ScrollAnimation>
        </div>
                ...
                <ScrollAnimation direction="up" key={activeCategory}>
                  <div className="mb-8 pb-6 border-b border-border">
                    ...
                    <p className="text-sm text-muted-foreground">
                      {currentCategory.items.length} pertanyaan dalam kategori
                      ini
                    </p>
                  </div>
                    ...
                    {currentCategory.items.map((item, idx) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            <span
                              className={`text-xs font-black mt-0.5 shrink-0 w-6 text-center transition-colors ${
                                isOpen
                                  ? "text-primary"
                            ...
                            <span
                              className={`flex-1 text-sm sm:text-base font-bold leading-snug font-heading transition-colors ${
                            ...
                            <ChevronDown
                              className={`size-4 shrink-0 mt-0.5 text-muted-foreground transition-transform duration-300 ${
